...
- What should Ralph build? (e.g., "Add Azure VM, Storage, and Networking APIs")
- Desired campaign name (suggest one derived from the task, e.g., `azure-compute`)
...
- **Each task line lists specific work** — e.g., `1.2: compute ListVMs + GetVM + integration tests`
